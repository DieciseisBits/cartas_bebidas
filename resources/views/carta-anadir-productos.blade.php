          ...
          <div id="producto_{{$i}}" class="col-md-6 producto-lista">
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="row">
                  <div class="col-xs-8">
                    {{ Form::text('titulo_'.$i, 'Título', array('class'=>'form-control input-sm','maxlength'=>'35')) }}
                    {{ Form::text('subtitulo_'.$i, 'Subtitulo', array('class'=>'form-control input-sm','maxlength'=>'35')) }}
                  </div>
                  <div class="col-xs-4">
                    ...
                    {{ Form::text('precio_'.$i, 'Precio', array('class'=>'form-control input-sm','maxlength'=>'5')) }}
                    {{ Form::text('precio_copa_'.$i, 'P. Copa', array('class'=>'form-control input-sm','maxlength'=>'5')) }}
                  </div>
                </div>
                <div class="row">
                  <div class="col-xs-12">
                    {{ Form::textarea('texto_'.$i, 'Texto', array('class'=>'form-control input-sm','rows'=>'3','maxlength'=>'210')) }}
                  </div>
                </div>
              </div>
              <div class="col-md-3">
